...
class CompletarTarea extends StatefulWidget {
  const CompletarTarea({super.key});

  @override
  State<CompletarTarea> createState() => _CompletarTareaState();
}

class _CompletarTareaState extends State<CompletarTarea> {
  //http://10.0.2.2:8000/tareas/
  //http://127.0.0.1:8000/tareas/
  final urlTareas = Uri.parse("http://127.0.0.1:8000/tareas/completadas/");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lista de tareas completadas'),
      ),
